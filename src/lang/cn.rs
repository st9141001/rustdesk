...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "就绪"),
        ("Established", "已建立"),
        ("connecting_status", "正在接入 Tako 网络..."),
        ("Enable service", "允许服务"),
        ("Start service", "启动服务"),
        ...
        ("Set Password", "设置密码"),
        ("OS Password", "操作系统密码"),
        ("install_tip", "你正在运行未安装版本，由于 UAC 限制，作为被控端，会在某些情况下无法控制鼠标键盘，或者录制屏幕，请点击下面的按钮将 Tako 安装到系统，从而规避上述问题。"),
        ("Click to upgrade", "点击这里升级"),
        ("Configure", "配置"),
        ("config_acc", "为了能够远程控制你的桌面, 请给予 Tako \"辅助功能\" 权限。"),
        ("config_screen", "为了能够远程访问你的桌面, 请给予 Tako \"屏幕录制\" 权限。"),
        ("Installing ...", "安装中..."),
        ("Install", "安装"),
        ("Installation", "安装"),
        ...
        ("android_input_permission_tip1", "为了让远程设备通过鼠标或触屏控制您的安卓设备，你需要允许 Tako 使用\"无障碍\"服务。"),
        ("android_input_permission_tip2", "请在接下来的系统设置页面里，找到并进入 [已安装的服务] 页面，将 [Tako Input] 服务开启。"),
        ...
        ("Turned off", "退出"),
        ("Language", "语言"),
        ("Keep RustDesk background service", "保持 Tako 后台服务"),
        ("Ignore Battery Optimizations", "忽略电池优化"),
        ("android_open_battery_optimizations_tip", "如需关闭此功能，请在接下来的 Tako 应用设置页面中，找到并进入 [电源] 页面，取消勾选 [不受限制]"),
        ("Start on boot", "开机自启动"),
        ...
        ("config_input", "为了能够通过键盘控制远程桌面, 请给予 Tako \"输入监控\" 权限。"),
        ("config_microphone", "为了支持通过麦克风进行音频传输，请给予 Tako \"录音\"权限。"),
        ...
        ("still_click_uac_tip", "依然需要被控端用户在运行 Tako 的 UAC 窗口点击确认。"),
        ...
        ("verify_rustdesk_password_tip", "验证 Tako 密码"),
        ...
        ("{} sessions", "{} 个会话"),
        ("scam_title", "你可能被骗了！"),
        ("scam_text1", "如果你正在和素不相识的人通话，而对方要求你使用 Tako 启动服务，请勿继续操作并立刻挂断电话。"),
        ...
        ("selinux_tip", "SELinux 处于启用状态，Tako 可能无法作为被控正常运行。"),
        ("Change view", "更改视图"),
        ("Big tiles", "大磁贴"),
        ("Small tiles", "小磁贴"),
        ("List", "列表"),
        ...
        ("allow-only-conn-window-open-tip", "仅当 Tako 窗口打开时允许连接"),
        ...
        ("Floating window", "悬浮窗"),
        ("floating_window_tip", "有助于保持 Tako 后台服务"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "请在远程端将 Tako 客户端升级至版本 {} 或更新版本！"),
        ...
        ("allow-insecure-tls-fallback-tip", "默认情况下，对于使用 TLS 的协议，Tako 会验证服务器证书。\n启用此选项后，在验证失败时，Tako 将转为跳过验证步骤并继续连接。"),
        ("Disable UDP", "禁用 UDP"),
        ("disable-udp-tip", "控制是否仅使用 TCP。\n启用此选项后，Tako 将不再使用 UDP 21116，而是使用 TCP 21116。"),
        ("server-oss-not-support-tip", "注意：Tako 开源服务器 (OSS server) 不包含此功能。"),
