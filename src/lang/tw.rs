...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "就緒"),
        ("Established", "已建立"),
        ("connecting_status", "正在連線到 Tako 網路..."),
        ("Enable service", "啟用服務"),
        ("Start service", "啟動服務"),
        ...
        ("Set Password", "設定密碼"),
        ("OS Password", "作業系統密碼"),
        ("install_tip", "UAC 會導致 Tako 在某些情況下無法正常作為遠端端點運作。若要避開 UAC，請點選下方按鈕將 Tako 安裝到系統中。"),
        ("Click to upgrade", "點選以升級"),
        ("Configure", "設定"),
        ("config_acc", "為了遠端控制您的桌面，您需要授予 Tako「無障礙功能」權限。"),
        ("config_screen", "為了遠端存取您的桌面，您需要授予 Tako「螢幕錄製」權限。"),
        ("Installing ...", "正在安裝..."),
        ("Install", "安裝"),
        ("Installation", "安裝"),
        ...
        ("android_input_permission_tip1", "為了讓遠端裝置能夠透過滑鼠或觸控控制您的 Android 裝置，您需要允許 Tako 使用「輔助功能」服務。"),
        ("android_input_permission_tip2", "請前往下一個系統設定頁面，找到並進入「已安裝的服務」，開啟「Tako Input」服務。"),
        ...
        ("Turned off", "已關閉"),
        ("Language", "語言"),
        ("Keep RustDesk background service", "保持 Tako 後台服務"),
        ("Ignore Battery Optimizations", "忽略電池最佳化"),
        ("android_open_battery_optimizations_tip", "如果您想要停用此功能，請前往下一個 Tako 應用程式設定頁面，找到並進入「電池」，取消勾選「不受限制」"),
        ("Start on boot", "開機時啟動"),
        ...
        ("config_input", "為了能夠透過鍵盤控制遠端桌面，請給予 Tako「輸入監控」權限。"),
        ("config_microphone", "為了支援透過麥克風進行音訊傳輸，請給予 Tako「錄音」權限。"),
        ...
        ("still_click_uac_tip", "依然需要遠端使用者在執行 Tako 時於 UAC 視窗點選「是」。"),
        ...
        ("verify_rustdesk_password_tip", "驗證 Tako 密碼"),
        ...
        ("{} sessions", "{} 個工作階段"),
        ("scam_title", "您可能遭遇詐騙！"),
        ("scam_text1", "如果您正在和素不相識的人通話，而對方要求您使用 Tako 啟用服務，請勿繼續操作並立即掛斷電話。"),
        ...
        ("selinux_tip", "SELinux 處於啟用狀態，Tako 可能無法作為被控端正常運作。"),
        ("Change view", "更改檢視方式"),
        ("Big tiles", "大磁磚"),
        ("Small tiles", "小磁磚"),
        ("List", "清單"),
        ...
        ("allow-only-conn-window-open-tip", "只在 Tako 視窗開啟時允許連接"),
        ...
        ("floating_window_tip", "有助於保持 Tako 後台服務"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "請將遠端 Tako 客戶端升級到 {} 或更新版本！"),
        ...
        ("allow-insecure-tls-fallback-tip", "預設情況下，對於使用 TLS 的協定，Tako 會驗證伺服器的憑證。\n啟用此選項後，在驗證失敗時，Tako 將轉為跳過驗證步驟並繼續連接。"),
        ("Disable UDP", "停用 UDP"),
        ("disable-udp-tip", "控制是否僅使用 TCP。\n啟用此選項後，Tako 將不再使用 UDP 21116，而是使用 TCP 21116。"),
        ("server-oss-not-support-tip", "注意：Tako 開源伺服器 (OSS server) 不包含此功能。"),
