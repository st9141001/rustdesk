...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the Tako network..."),
        ...
        ("install_tip", "Due to UAC, Tako can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install Tako to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant Tako \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant Tako \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow Tako to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [Tako Input] service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next Tako application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant Tako \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant Tako \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running Tako."),
        ...
        ("verify_rustdesk_password_tip", "Verify Tako password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use Tako and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Please upgrade Tako Server Pro to version {} or newer!"),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent Tako from running properly as controlled side."),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if Tako window is open"),
        ...
        ("floating_window_tip", "It helps to keep Tako background service"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Please upgrade the Tako client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, Tako verifies the server certificate for protocols using TLS.\nWith this option enabled, Tako will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, Tako will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: Tako server OSS doesn't include this feature."),
